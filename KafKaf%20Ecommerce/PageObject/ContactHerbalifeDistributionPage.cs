...
{
    public class ContactHerbalifeDistributionPage
    {
        public IWebDriver driver;
        public ContactHerbalifeDistributionPage()
        {
        ...
        private IWebElement startTodayWithHerbalife => driver.FindElement(By.XPath("//a[normalize-space()='Start Today with Herbalife']"));
        private IWebElement assertCHDPage => driver.FindElement(By.XPath("//h1[normalize-space()='Contact Herbalife  Distributor']"));
        ...
        //private IWebElement responseMessage => driver.FindElement(By.ClassName("forminator-error-message"));
        ...
        public void UserClicksOnStartTodayWithHerbalife()
        {
            startTodayWithHerbalife.Click();
        }
